...
namespace DAO.Implementation
{
    public class SaleImpl : ISale
    {
        ...
        public void Insert(Sale t, List<SaleDetail> d)
        {
            ...
            string queryDetail = @"INSERT INTO SaleDetail (saleID, wineID , quantiy,price)
                                    VALUES  (@saleID, @wineID , @quantiy,@price) ";
            try
            {
                ...
                for (int i = 0; i < commands.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        commands[i].Parameters.AddWithValue("@wineID",d[i-1].WineID);
